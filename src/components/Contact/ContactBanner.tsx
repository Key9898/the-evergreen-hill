...
const ContactImg = '/Contact/contact_banner_img.jpg'
...
export default function ContactBanner({ onNavigate }: ContactBannerProps) {
  ...
  const breadcrumbPages = [{ name: 'Contact', href: '#contact', current: true }]
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center px-4 sm:px-6 pt-56 pb-20 sm:pt-64 sm:pb-32 lg:pt-72 lg:pb-40 text-center lg:px-8">
        ...
        >
          ...
          <motion.p
            ...
            variants={fadeInUp}
          >
            Whether you have a question or are planning a special occasion, our dedicated team is
            here to provide the personal assistance you need for a perfect Kalaw getaway.
          </motion.p>
        </motion.div>
      </div>
    </div>

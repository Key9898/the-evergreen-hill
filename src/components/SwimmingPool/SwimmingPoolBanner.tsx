      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center px-4 sm:px-6 pt-32 pb-20 sm:pt-40 sm:pb-32 lg:pt-48 lg:pb-40 text-center lg:px-8">
        ...
        >
          ...
          <motion.p
            ...
            variants={fadeInUp}
          >
            Leave the world behind at your highland oasis. Our stunning, temperature-controlled pool
            is the perfect place to unwind with a refreshing dip while soaking in the breathtaking
            mountain views.
          </motion.p>
        </motion.div>
      </div>

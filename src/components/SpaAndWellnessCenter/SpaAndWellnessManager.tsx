...
const SpaAndWellnessManagerPhoto = '/Team/spa_wellness_manager.jpg'
          ...
          >
            <blockquote className="text-slate-900">
              ...
              <p className="mt-4 text-lg/8 text-slate-700">
                Guided by our Spa & Wellness Manager, Ma Thida Win, our philosophy is all about
                balance. We combine serene, traditional Shan therapies for restoration with a modern
                fitness center for recharging, helping you leave feeling your absolute best.
              </p>
            </blockquote>
          </motion.div>
          <motion.div

...
const LeadConciergePhoto = '/Team/lead_concierge.jpg'
          ...
          >
            <blockquote className="text-slate-900">
              ...
              <p className="mt-4 text-lg/8 text-slate-700">
                Think of me as your personal guide to the heart of the Shan highlands. My passion is
                to help you discover Kalaw's hidden gems, from the most scenic treks to authentic
                local experiences.
              </p>
            </blockquote>
          </motion.div>

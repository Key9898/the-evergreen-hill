...
const ActivitiesImg = '/Activities/activities_banner_img.jpg'
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center px-4 sm:px-6 pt-56 pb-20 sm:pt-64 sm:pb-32 lg:pt-72 lg:pb-40 text-center lg:px-8">
        ...
        >
          ...
          <motion.p
            ...
            variants={fadeInUp}
          >
            Step beyond the sanctuary of our hotel and into the breathtaking landscapes of Kalaw. We
            offer curated adventures that connect you with the nature, culture, and spirit of the
            Shan highlands.
          </motion.p>
        </motion.div>
      </div>
